...
A estrutura preservada inclui páginas em \`section\`, cabeçalho semântico, conteúdo em \`pre\`,
acordes em \`b[data-chord-name]\`, diagramas com \`data-chord-mode\` e controles nativos em
\`aside\`.
